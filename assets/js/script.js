...
// Loop through all "eye" buttons
projectBtns.forEach(btn => {
  btn.addEventListener("click", function (e) {
    e.preventDefault(); // Prevent page reload
    // Find the image inside the same project item
    ...
    if (portfolioModal && portfolioModalImg) {
      ...
      portfolioCaption.innerHTML = projectImg.alt;
    }
  });
});
...
// Close portfolio modal if clicking outside the image
